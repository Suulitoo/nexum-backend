...
// Dans index.js, ajoute ces routes simples (sans DB)
...
// Callback minimal (sans DB, juste redirige vers shop avec un paramètre)
app.get('/auth/discord/callback', async (req, res) => {
  const code = req.query.code;
  if (!code) return res.redirect('/login?error=no_code');

  // Ici tu peux garder juste une redirection simple pour tester
  res.redirect(`/shop?logged_in=true&code_received=${code}`);
});
